...
cp -f libmbedcrypto.2.27.0.dylib "$HOME/Library/Application Support/ShadowsocksX-NG-RX/"
cp -f libmbedcrypto.7.dylib "$HOME/Library/Application Support/ShadowsocksX-NG-RX/"
